...
Телеграм-бот с «аватарами»-персонажами: выбираешь стиль общения (военный офицер, бандит, викинг, и т.д.), бот ведёт диалог в выбранной манере, помнит контекст и бережёт лимиты. Реализована автоматическая смена модели LLM при исчерпании квоты/ошибках провайдера.

> **Демо-название:** RolePlayBot
...
- 🔁 **Failover моделей**: список моделей в `.env` (`OPENROUTER_MODELS`). При 429/403/402/5xx — автоматический переход на следующую
